...
## Combine 
tiff("figure_2.tif", width = 180, height = 90, units = "mm", res = 520, compression = "lzw")
...
tiff("figure_3.tif", width = 180, height = 90, units = "mm", res = 520, compression = "lzw")
...
tiff("figure_4.tif", width = 180, height = 90, units = "mm", res = 520, compression = "lzw")
...
tiff("figure_5.tif", height = 130, width = 180, res = 460, units = "mm", compression = "lzw")
...
tiff("figure_6.tif", width = 180, height = 90, units = "mm", res = 520, compression = "lzw")
...
tiff("figure_7.tif", width = 180, height = 80, units = "mm", res = 520, compression = "lzw")
...
tiff("figure_8.tif", width = 180, height = 90, res = 520, units = "mm", compression = "lzw")
